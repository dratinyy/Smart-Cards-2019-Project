...
namespace AskReaderLib
{
    ...
    public static class CSC
    {
        ...
        public static extern Int32 EHP_PARAMS_EXT(Byte MaxNbCard, Byte Req, Byte NbSlot, Byte AFI, Byte AutoSelDiv,
            Byte Deselect, Byte SelectAppli, Byte Lg, Byte[] Data, Int16 FelicaAFI, Byte FelicaNbSlot);
