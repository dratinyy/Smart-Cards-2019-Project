...
#define CSC_CLA_SRX										0x06
#define CSC_RATP										0x07 // Reserved by Ratp for compatibility
#define CSC_CLA_MIFARE									0x10
#define CSC_CLA_DESFIRE									0x11
#define CSC_CLA_MFP_SL3									0x13
#define CSC_CLA_MIFARE_SAMNXP							0x14
#define CSC_CLA_MFUL									0x16
...
#define	CSC_WRITE_CONFIG_EEPROM							0x07
#define	CSC_READ_CONFIG_EEPROM							0x08


/* SYSTEM Class Functions */
#define CSC_SYS_RESET									0x00
...
#define	CSC_SYS_SEND_TO_ANTENNA_EXT						0x22
#define CSC_SYS_SAM_BAUDRATE_PPS						0x27
#define CSC_SYS_EMV_USER_INTERFACE						0x40
#define CSC_SYS_EMV_CONTACTLESS							0x41
...
#define CSC_CD97_SELECT_ISO_APPLICATION					0x15
...
#define CSC_GEN_CHANGE_KEY								0x02
...
#define CSC_GEN_DECREASELG								0x23
#define CSC_GEN_INCREASELG								0x24
#define CSC_GEN_CALYPSO_REV3_MODE						0x30
...
#define CSC_MIFARE_READMULTIPLEBLOCK					0x0D
#define CSC_MIFARE_SIMPLEWRITEBLOCK						0x0E
#define CSC_MIFARE_READSECTORDATA						0x0F
#define CSC_MIFARE_WRITESECTORDATA						0x10

/*----------------- MIFARE PLUS SL3 Defines --------------------*/
#define CSC_MFP_SL3_AUTHENTICATE						0x01
#define CSC_MFP_SL3_RESETAUTHENTICATE					0x02
#define CSC_MFP_SL3_READBLOCK							0x03
#define CSC_MFP_SL3_WRITEBLOCK							0x04
#define CSC_MFP_SL3_CHANGEKEY							0x05
#define CSC_MFP_SL3_VIRTUALCARDSUPPORT					0x06
#define CSC_MFP_SL3_DESELECTVIRTUALCARD					0x07

/*----------------- MIFARE SAMNXP Defines --------------------*/
#define CSC_MIFARE_SAMNXP_AUTHENTICATE					0x01
#define CSC_MIFARE_SAMNXP_REAUTHENTICATE				0x02
#define CSC_MIFARE_SAMNXP_READBLOCK						0x03
#define CSC_MIFARE_SAMNXP_WRITEBLOCK					0x04
#define CSC_MIFARE_SAMNXP_CHANGEKEY						0x05
#define CSC_MIFARE_SAMNXP_INCREMENT						0x06
#define CSC_MIFARE_SAMNXP_DECREMENT						0x07
#define CSC_MIFARE_SAMNXP_BACKUP						0x08
#define CSC_MIFARE_SAMNXP_KILLAUTHENT					0x09

/*----------------- SRx Defines --------------------*/
#define CSC_SRX_ACTIVATE								0x31
#define CSC_SRX_READBLOCK								0x32
#define CSC_SRX_WRITEBLOCK								0x33
#define CSC_SRX_RELEASE									0x34
#define CSC_SRX_READ									0x35
#define CSC_SRX_WRITE									0x36

/*----------------- Desfire Defines --------------------*/
#define CSC_DESFIRE_PREPARE_AUTHENTICATION				0x00
#define CSC_DESFIRE_CREATEAPPLICATION					0x01
#define CSC_DESFIRE_DELETEAPPLICATION					0x02
#define CSC_DESFIRE_SELECTAPPLICATION					0x03
#define CSC_DESFIRE_FORMATPICC							0x04
#define CSC_DESFIRE_GETAPPLICATIONIDS					0x05
#define CSC_DESFIRE_GETVERSION							0x06
#define CSC_DESFIRE_GETFREEMEM							0x07
#define CSC_DESFIRE_AUTHENTICATION						0x08
#define CSC_DESFIRE_COMMITTRANSACTION					0x09
#define CSC_DESFIRE_ABORTTRANSACTION					0x0A
#define CSC_DESFIRE_CHANGEKEY							0x0B
#define CSC_DESFIRE_CHANGEKEYSETTING					0x0C
#define CSC_DESFIRE_GETKEYSETTING						0x0D
#define CSC_DESFIRE_GETKEYVERSION						0x0E
#define CSC_DESFIRE_CHANGEFILESETTING					0x10
#define CSC_DESFIRE_CLEARRECORDFILE						0x11
#define CSC_DESFIRE_CREATEBACKUPDATAFILE				0x12
#define CSC_DESFIRE_CREATECYCLICRECORDFILE				0x13
#define CSC_DESFIRE_CREATELINEARRECORDFILE				0x14
#define CSC_DESFIRE_CREATESTANDARDDATAFILE				0x15
#define CSC_DESFIRE_CREATEVALUEFILE						0x16
#define CSC_DESFIRE_CREDIT								0x17
#define CSC_DESFIRE_DEBIT								0x18
#define CSC_DESFIRE_DELETEFILE							0x19
#define CSC_DESFIRE_GETFILEID							0x1A
#define CSC_DESFIRE_GETFILESETTING						0x1B
#define CSC_DESFIRE_GETVALUE							0x1C
#define CSC_DESFIRE_LIMITEDCREDIT						0x1D
#define CSC_DESFIRE_READDATA							0x1E
#define CSC_DESFIRE_READRECORD							0x1F
#define CSC_DESFIRE_WRITEDATA							0x20
#define CSC_DESFIRE_WRITERECORD							0x21
#define CSC_DESFIRE_SAMGETVERSION						0x22
#define CSC_DESFIRE_SAMSELECTAPPLICATION				0x23
#define CSC_DESFIRE_SAMLOADINITVECTOR					0x24
#define CSC_DESFIRE_SAMGETKEYENTRY						0x25
#define CSC_DESFIRE_SAMGETKUCENTRY						0x26
#define CSC_DESFIRE_SAMDISABLECRYPTO					0x27
#define CSC_DESFIRE_AUTHENTICATE_EV1					0x30

/*----------------- MIFARE ULTRALIGHT Defines --------------------*/
#define CSC_MFUL_IDENTIFY					0x00
#define CSC_MFUL_READ						0x22
#define CSC_MFUL_WRITE						0x23
#define CSC_MFUL_C_AUTHENTICATE				0x24
#define CSC_MFUL_C_WRITE_KEY_FROM_SAM		0x25
#define CSC_MFUL_EV1_PASSWORD_AUTHENTICATE	0x26
#define CSC_MFUL_EV1_CREATE_PASSWORD_PACK	0x2B
#define CSC_MFUL_EV1_READ_COUNTER			0x27
#define CSC_MFUL_EV1_INCREMENT_COUNTER		0x28
#define CSC_MFUL_EV1_GET_VERSION			0x29
#define CSC_MFUL_EV1_CHECK_TEARING_EVENT	0x2A
